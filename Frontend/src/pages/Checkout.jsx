      ...
      <div className="max-w-2xl mx-auto px-6">
        ...
        {checkoutStep === 3 ? (
          <div className="max-w-2xl mx-auto p-4 sm:p-8 bg-white border border-light-border/60 rounded-3xl shadow-sm text-center relative overflow-hidden animate-fadeIn">
            ...
            <div className="my-6 p-5 bg-white border border-light-border/60 rounded-2xl text-left space-y-4 shadow-3xs">
              <div className="flex justify-between items-center pb-2 border-b border-slate-100">
                <h3 className="text-xs font-extrabold text-dark-navy uppercase tracking-wider flex items-center gap-1.5">
                ...
                <span className="text-[10px] bg-indigo-50 text-indigo-650 px-2.5 py-0.5 rounded-full font-black uppercase tracking-wider border border-indigo-100/50">
                  Processing
                </span>
              </div>
              
              {/* Stepper Graphics */}
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 sm:gap-2 py-2 relative w-full">
                {/* Step 1: Processing */}
                <div className="flex sm:flex-col items-center gap-2.5 sm:gap-1.5 flex-1 z-10 text-left sm:text-center w-full">
                  <div className="w-7 h-7 rounded-full bg-primary text-white border-2 border-primary flex items-center justify-center font-bold text-[10px] shadow-xs">
                    1
                  </div>
                  <div>
                ...
                {/* Connector 1 */}
                <div className="hidden sm:block flex-1 h-[2px] bg-slate-100 mx-2"></div>
                <div className="sm:hidden w-[2px] h-4 bg-slate-100 ml-3.5 -my-2"></div>

                {/* Step 2: Shipped */}
                <div className="flex sm:flex-col items-center gap-2.5 sm:gap-1.5 flex-1 z-10 text-left sm:text-center w-full">
                  <div className="w-7 h-7 rounded-full bg-white text-muted-gray border-2 border-slate-200 flex items-center justify-center font-bold text-[10px]">
                    2
                  </div>
                  <div>
                    <h4 className="text-[11px] font-bold text-muted-gray leading-none">Shipped</h4>
                    <p className="text-[9px] text-muted-gray mt-0.5 font-semibold">In transit</p>
                  </div>
                </div>
                ...
                <div className="flex sm:flex-col items-center gap-2.5 sm:gap-1.5 flex-1 z-10 text-left sm:text-center w-full">
                  ...
                  <div>
                    <h4 className="text-[11px] font-bold text-muted-gray leading-none">Delivered</h4>
              ...
              {/* Delivery Estimation */}
              <div className="bg-slate-50 border border-slate-100/50 rounded-xl p-3 text-[10px] sm:text-xs font-semibold text-muted-gray flex items-center gap-2">
                <span>🚚</span>
                <span>
                  Estimated delivery by <strong className="text-dark-navy">{
