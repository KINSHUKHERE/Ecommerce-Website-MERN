    ...
    <div className="min-h-screen w-full bg-soft-bg/40 flex items-center justify-center px-6 py-12 text-dark-navy antialiased">
      ...
      <div className="w-full max-w-md bg-white border border-light-border/60 shadow-2xs rounded-3xl p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-5 text-left">
          ...
          {formData.role === "vendor" && (
            <div className="flex items-start gap-2.5 bg-slate-50 p-3 rounded-xl border border-light-border/40">
              <input
                type="checkbox"
                id="signupAgreeTerms"
                name="agreeTerms"
              ...
              />
              <label htmlFor="signupAgreeTerms" className="text-[11px] font-semibold text-muted-gray leading-tight">
