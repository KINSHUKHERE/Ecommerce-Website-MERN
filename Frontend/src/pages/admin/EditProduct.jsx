...
const EditProduct = () => {
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        console.log("Error loading product for editing:", err);
      } finally {
        setLoading(false);
      }
    };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log("Unable to update product details:", err);
    }
  };
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center">
        ...
        <p className="text-gray-500 mt-4 animate-pulse text-sm">Loading product details...</p>
      </div>
    );
  }
        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-150 p-5 sm:p-7 relative overflow-hidden">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-gray-500 font-medium text-xs sm:text-sm">
              Modify the product details in the database catalog.
            </p>
          </div>
