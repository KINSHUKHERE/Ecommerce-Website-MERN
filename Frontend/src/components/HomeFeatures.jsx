        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
          {categories.map((cat) => (
            <div
              ...
              className="group flex flex-col items-center justify-center p-5 bg-white border border-light-border/60 rounded-3xl hover:border-primary/20 shadow-[0_8px_30px_rgb(0,0,0,0.01)] hover:shadow-[0_16px_35px_rgba(15,157,138,0.04)] hover:-translate-y-1 transition-all duration-300 cursor-pointer"
            >
